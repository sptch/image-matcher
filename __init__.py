...
def register_classes(unregister=False):
    ...
    classes = [
        ...
        export.OBJECT_OT_copy_typescript_object,
        export.OBJECT_OT_copy_all_typescript_objects,
        export.OBJECT_OT_copy_scene_camera_typescript,
        export.OBJECT_OT_copy_selected_camera_typescript,
        export.OBJECT_OT_init_camera_typescript_properties,
